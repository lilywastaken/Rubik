...
void Cube::moveSide(int motion) {
	...
	case 0:
		...
		tempColor = right.upper.left;
		this->right.upper.left = right.lower.left;
		this->right.lower.left = right.lower.right;
		this->right.lower.right = right.upper.right;
		this->right.upper.right = tempColor;
		
		tempColor = left.upper.left;
		this->left.upper.left = left.upper.right;
		this->left.upper.right = left.lower.right;
		this->left.lower.right = left.lower.left;
		this->left.lower.left = tempColor;
		
		tempColor = back.upper.left;
		this->back.upper.left = back.lower.right;
		this->back.lower.right = tempColor;
		tempColor = back.upper.right;
		this->back.upper.right = back.lower.left;
		this->back.lower.left = tempColor;
		
		tempColor = down.upper.left;
		this->down.upper.left = down.lower.right;
		this->down.lower.right = tempColor;
		tempColor = down.upper.right;
		this->down.upper.right = down.lower.left;
		this->down.lower.left = tempColor;
	...
	case 1:
		...
		tempColor = up.upper.left;
		this->up.upper.left = up.lower.left;
		this->up.lower.left = up.lower.right;
		this->up.lower.right = up.upper.right;
		this->up.upper.right = tempColor;
		
		tempColor = down.upper.left;
		this->down.upper.left = down.upper.right;
		this->down.upper.right = down.lower.right;
		this->down.lower.right = down.lower.left;
		this->down.lower.left = tempColor;
	...
	case 2:
		...
		tempColor = left.upper.left;
		this->left.upper.left = left.lower.left;
		this->left.lower.left = left.lower.right;
		this->left.lower.right = left.upper.right;
		this->left.upper.right = tempColor;
		
		tempColor = right.upper.left;
		this->right.upper.left = right.upper.right;
		this->right.upper.right = right.lower.right;
		this->right.lower.right = right.lower.left;
		this->right.lower.left = tempColor;
		...
		tempColor = up.upper.left;
		this->up.upper.left = up.lower.right;
		this->up.lower.right = tempColor;
		tempColor = up.upper.right;
		this->up.upper.right = up.lower.left;
		this->up.lower.left = tempColor;
	...
	case 3:
		...
		tempColor = down.upper.left;
		this->down.upper.left = down.lower.left;
		this->down.lower.left = down.lower.right;
		this->down.lower.right = down.upper.right;
		this->down.upper.right = tempColor;
		
		tempColor = up.upper.left;
		this->up.upper.left = up.upper.right;
		this->up.upper.right = up.lower.right;
		this->up.lower.right = up.lower.left;
		this->up.lower.left = tempColor;
